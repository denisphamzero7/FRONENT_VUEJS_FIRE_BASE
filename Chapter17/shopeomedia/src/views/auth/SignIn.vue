        ...
        <div class="card shadow-sm">
          <div class="card-body p-4">
            ...
            <p class="text-muted small text-center mb-3">
              Đăng nhập để quản lý sản phẩm và truy cập dashboard
            </p>
            ...
            <div class="text-center small text-muted">Hoặc đăng nhập bằng</div>
            <div class="d-flex gap-2 justify-content-center mt-3">
              <!-- placeholders — wire to actual social auth if available -->
              <button class="btn btn-outline-primary btn-sm" type="button" :disabled="loading">
                Google
              </button>
              <button class="btn btn-outline-dark btn-sm" type="button" :disabled="loading">
                Github
              </button>
            </div>
          </div>
